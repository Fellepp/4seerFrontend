...
const ConnectedLinereg = ({ columns, inputs, changeInputs, states, changeState, img, changeImage }) => {
    ...
    return (
        <div>
            ...
            <input placeholder='Enter player name here...' type='text' id='x_label' name='x-label' onChange={handleChange}></input><br/>
...
const Linereg = connect(mapStateToProps, mapDispatchToProps)(ConnectedLinereg)


export default Linereg