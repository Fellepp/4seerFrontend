...
const ConnectedBoxplot = ({ columns, inputs, changeInputs, states, changeState, img, changeImage }) => {
...
const Boxplot = connect(mapStateToProps, mapDispatchToProps)(ConnectedBoxplot)
