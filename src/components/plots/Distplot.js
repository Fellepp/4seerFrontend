...
const ConnectedDistplot = ({ columns, inputs, changeInputs, states, changeState, img, changeImage }) => {
...
const Distplot = connect(mapStateToProps, mapDispatchToProps)(ConnectedDistplot)
