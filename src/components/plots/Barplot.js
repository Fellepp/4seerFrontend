...
const ConnectedBarplot = ({ columns, inputs, changeInputs, states, changeState, img, changeImage }) => {
...
const Barplot = connect(mapStateToProps, mapDispatchToProps)(ConnectedBarplot)
